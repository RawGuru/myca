  ...
  if (screen === 'editVideo') {
    return (
      <EditVideoScreen
        ...
        onNavigate={setScreen}
        onSetVideoStep={setVideoStep}
        onSetVideoJustSaved={setVideoJustSaved}
        onSetMyGiverProfile={setMyGiverProfile}
        onSetRecordedUrl={setRecordedUrl}
        onSetProfileError={setProfileError}
        ...
        onSetAvailabilitySlots={setAvailabilitySlots}
